...
RUN install2.r renv remotes rjags neonstore ISOweek RNetCDF devtools fable fabletools forecast imputeTS ncdf4 scoringRules tidybayes tidync udunits2 bench contentid flexdashboard shiny yaml
